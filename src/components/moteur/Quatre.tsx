...
/* Les cinq groupes, dans l'ordre du moteur, avec la clé du mot qui les nomme
   dans le panneau de l'application. Le classement est le même, montré
   autrement : la page n'invente pas un second vocabulaire. */
const GROUPES: readonly { id: Groupe; cle: 'groupeAbstraits' | 'groupeMatieres'
 ...
 * font. C'est l'application en trois rangées, pas en soixante-trois vignettes :
 * une liste complète des familles referait le panneau de l'outil dans un autre
 * document, ce que le design refuse. Les cinq groupes disent le classement, et
